...
var UsersModifyUseCase = /** @class */ (function () {
    function UsersModifyUseCase(database) {
        this.database = database;
        this.database = database;
    }
    UsersModifyUseCase.prototype.execute = function (id, body) {
        return __awaiter(this, void 0, void 0, function () {
            var user, responseModel, userOnDb, _a, _b, error_1;
    ...
    return UsersModifyUseCase;
}());
exports.default = UsersModifyUseCase;
